package com.getzephyr.qa.sub.one;

import junit.framework.Test;
import junit.framework.TestCase;
import junit.framework.TestSuite;

public class AppBulk20Test extends TestCase{
	     ...
	     */
	    public AppBulk20Test(String testName )
	    {
	        super( testName );
	    }
	    ...
	    {
	        return new TestSuite( AppBulk20Test.class );
	    }
