package com.getzephyr.qa.sub.three;

import junit.framework.Test;
import junit.framework.TestCase;
import junit.framework.TestSuite;

public class AppBulk30Test extends TestCase{
	     ...
	     */
	    public AppBulk30Test(String testName )
	    {
	        super( testName );
	    }
	    ...
	    {
	        return new TestSuite( AppBulk30Test.class );
	    }
	    ...
	    public void testApp3() {
	    	assertEquals("anil", "anil");
	    }
	    
	    public void testApp4() {
	    	assertEquals("anil", "anilkumar");
	    }
